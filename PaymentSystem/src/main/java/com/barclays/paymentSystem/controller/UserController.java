...
public class UserController {
	...
	public ResponseEntity<User> getuserDetails(@PathVariable @Min(value = 1, 
	message = "{user.loginid.invalid}") @Max(value = 10000, 
	message = "{user.loginid.invalid}") Integer loginId)  throws PaymentsException{  
